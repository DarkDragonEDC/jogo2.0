...
const CombatPanel = ({ socket, gameState, isMobile }) => {
        ...
        return (
            <div style={{ display: 'flex', flexDirection: 'column', height: '100%', gap: isMobile ? '8px' : '10px', padding: isMobile ? '8px' : '10px', overflowY: 'auto' }}>
                ...
                <div style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', gap: '20px', flex: isMobile ? 'none' : 1, minHeight: 0 }}>
                    ...
                    <div style={{ flex: isMobile ? 'none' : 1.5, display: 'flex', flexDirection: 'column', gap: '8px', minHeight: isMobile ? '350px' : '0' }}>
                        {/* Stats Dashboard */}
                        <div className="glass-panel" style={{
                            padding: '8px',
                            display: 'grid',
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
            ...
            {/* Mobs Grid */}
            <div className="glass-panel scroll-container" style={{ flex: 1, padding: isMobile ? '10px' : '20px', background: 'rgba(10, 10, 15, 0.4)' }}>
